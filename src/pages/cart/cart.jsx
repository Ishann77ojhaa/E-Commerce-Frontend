            ...
            <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
              ...
              <div className="flex justify-between mt-4 sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
                <div className="flex items-center border-gray-100">
                  ...
                  <input className="w-8 h-8 text-xs text-center bg-white border outline-none" type="number"  value={product.quantity} readOnly min="1" />
                ...
                <div className="flex items-center space-x-4">
                  <p className="text-sm">
                    {(product.Product_Price * product.quantity).toLocaleString()} rs 
                  </p>
